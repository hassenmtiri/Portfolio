...
const modalContent = {
  Project_1: {
    title: "3d portfolio",
    content:
      "Welcome to my 3D portfolio — a collection of models that showcase my skills in character design, hard–surface modeling, texturing, rigging, lighting, and real-time optimization. My work combines artistic creativity with clean topology and technical precision, ensuring models that are both visually appealing and production-ready for games, animation, and interactive experiences",
    link: "https://hassenmtiri.github.io/3d-Works/",
  },
  Project_2: {
    title: "📋ToDo List✏️",
    content:
      "This portfolio gathers all the websites I designed and developed — each one crafted with care, creativity, and attention to detail. From layout (photoshop and packs creation) and music productio to animations, every project reflects my passion for modern and engaging web design.",
    link: "https://hassenmtiri.github.io/MyWebsites/",
  },
  Project_3: {
    title: "🌞Weather App😎",
    content:
      "Welcome to my Game Portfolio — a collection of the projects I’ve designed and developed. Each game demonstrates my skills in gameplay design, mechanics, scripting, character control, level building, and optimization.From small prototypes to full experiences, I focus on creating fun, interactive, and responsive gameplay.Explore my work and see how I bring ideas to life through code, creativity, and game design.",
    link: "https://github.com/hassenmtiri/My-Games/settings/pages",
  },
